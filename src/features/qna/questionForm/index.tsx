...
const allTalks = [
  {
    title: "Встречи 1-1: как разблокировать весь потенциал встреч с лидом",
    speaker: "Соня Волынская",
    timeEnd: 1707426000000,
  },
  {
    title: "Сквозь время: ускоряем автотесты",
    speaker: "Всеволод Золотов",
    timeEnd: 1707426000000,
  },
  {
    title: "Генерация http-клиента с помощью swagger-codegen",
    speaker: "Павел Гонзалес",
    timeEnd: 1707426000000,
  },
  {
    title: "Мы не зависим от бэкенда",
