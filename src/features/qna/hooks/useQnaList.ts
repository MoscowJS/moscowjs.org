...
const allTalks: Talk[] = [
  {
    title: "Что можно не знать про LLM, чтобы создать себе замену",
    speaker: "Андрей Толстых",
    timeEnd: 1749150000000,
  },
  {
    title: "Ох уж этот AI! Что ты такое?",
    speaker: "Александр Ермолов",
    timeEnd: 1749150000000,
  },
  {
    title: "AI в QA: UI тесты простым языком",
    speaker: "Даниил Ахетов",
    timeEnd: 1749150000000,
  },
  {
    title: "AI и безопасность при работе с NPM",
    speaker: "Анастасия Егорова",
    timeEnd: 1749150000000,
  },
]
