...
const allTalks: Talk[] = [
  {
    title: "Базовые принципы самопомощи, или почему опытному разработчику нужно стать наставником",
    speaker: "Тимур Гафиулин",
    timeEnd: 1720720800000,
  },
  {
    title: "Профилирование памяти и снапшоты",
    speaker: "Владислав Молоцило",
    timeEnd: 1720720800000,
  },
  {
    title: "Фронтенд без границ",
    speaker: "Виктор Щеглов",
    timeEnd: 1720720800000,
  },
  {
    title: "От Mobile First к PWA, или почему стоит вернуться к основам веб-разработки",
    speaker: "Зар Захаров",
    timeEnd: 1720720800000,
  },
]
