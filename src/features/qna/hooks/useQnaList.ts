...
const allTalks: Talk[] = [
  {
    title: "Бекстейдж блога с WebRTC",
    speaker: "Юлия Корецкая",
    timeEnd: 1692903600000,
  },
  {
    title: "Применение алгоритма Дейкстры для построения траектории движения в 2D-пространстве",
    speaker: "Александр Пономаренко",
    timeEnd: 1692903600000,
  },
  {
    title: "Причины неудач распространения библиотеки компонентов. Опыт Учи.ру",
    speaker: "Артём Арефьев",
    timeEnd: 1692903600000,
  },
  {
    title: "Сам себе лид",
    speaker: "Кирилл Павлик",
    timeEnd: 1692903600000,
  },
]
