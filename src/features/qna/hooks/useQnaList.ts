...
const allTalks: Talk[] = [
  {
    title: "Путь JavaScript-инженера в мир DeFi",
    speaker: "Даниил Швецов",
    timeEnd: 1756407600000,
  },
  {
    title: "Архитектура микрофронтендов: от А до Single Spa",
    speaker: "Павел Шлыков",
    timeEnd: 1756407600000,
  },
  {
    title: "Под капотом платформы",
    speaker: "Антон Марченко",
    timeEnd: 1756407600000,
  },
  {
    title: "Гильдия: место, где разработчик перестаёт быть одиноким кузнецом",
    speaker: "Владислав Сазонов",
    timeEnd: 1756407600000,
  },
]
