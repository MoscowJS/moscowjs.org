...
const allTalks: Talk[] = [
  {
    title: "Монады или зачем программисту математика",
    speaker: "Александр Князев",
    timeEnd: 1700766000000,
  },
  {
    title: "Реализация DDD в рамках NestJS",
    speaker: "Сердар Садыков",
    timeEnd: 1700766000000,
  },
  {
    title: "Nextjs 13 Server Actions - Святой Грааль Fullstack-разработки",
    speaker: "Арсалан Рабданов",
    timeEnd: 1700766000000,
  },
  {
    title: "Стартап, который смог: как изменить подход к разработке, не сбавляя темп",
