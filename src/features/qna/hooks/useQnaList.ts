...
const allTalks: Talk[] = [
  {
    title: "Чистая архитектура фронтенд-приложений",
    speaker: "Шандер Кристиан",
    timeEnd: 1743109200000,
  },
  {
    title: "Путь от Senior Web разработчика до Tech Lead Web",
    speaker: "Колпаков Александр",
    timeEnd: 1743109200000,
  },
  {
    title: "AI во фронтенде: преимущества внедрения машинного обучения в браузере",
    speaker: "Ямилов Булат",
    timeEnd: 1743109200000,
  },
  {
    title: "Надо, но завтра: как подчинить себе прокрастинацию",
    speaker: "Уварова Юлия",
    timeEnd: 1743109200000,
  },
]
